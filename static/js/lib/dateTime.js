...
function(){
	...
	fd.write('<table width="100%" border="0" bgcolor="#0099CC" cellspacing="1" cellpadding="0">'+
			 ...
			 '<tr bgcolor="#0099CC"><td><table width="100%" border="0" bgcolor="#8F8C8F" cellspacing="1" cellpadding="0">'+
			 '<tr bgcolor="#0099CC" height="18"><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr></table></td></tr>'+
			 '<tr bgcolor="#0099CC"><td><div id="calenderDay"></div></td></tr>'+
